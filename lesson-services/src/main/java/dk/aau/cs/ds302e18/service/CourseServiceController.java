...
public class CourseServiceController {
    ...
    */
    ...
    @PostMapping
    public ResponseEntity<Course> createEmptyCourse(/*Integer courseID,*/ @RequestBody CourseModel model) {
        Course course = courseRepository.save(model.translateModelToCourse());
